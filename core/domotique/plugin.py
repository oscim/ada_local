...
class DomotiquePlugin(BasePlugin):
    ...
    # ── Function definitions (tool-calling LLM) ───────────────────────────────
    ...
    def get_function_definitions(self) -> list[dict]:
        return [
            ...
            },
            {
                ...
                "function": {
                    ...
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "scene": {"type": "string", "enum": ["focus", "relax", "night", "off", "security"], "description": "Nom de la scène à activer"},
                        },
                        "required": ["scene"],
                    },
                },
            ...
            },
            {
                ...
                "function": {
                    "name": "alarm_set",
                    "description": "Arme ou désarme l'alarme de la maison. CONFIRMATION REQUISE avant exécution.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                    ...
                    "x_confirm_message": "Confirmer le changement d'état de l'alarme ?",
                },
            },
            {
                "type": "function",
                "function": {
                    "name": "cover_control",
                    "description": "Contrôle un volet, store ou portail via Home Assistant.",
                    "parameters": {
                        "type": "object",
                        "properties": {
            ...
            },
            {
                ...
                "function": {
                    ...
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "entity": {"type": "string", "description": "ID de l'entité (optionnel — si absent, retourne tous les appareils)"},
                        },
                    },
                },
            },
    ...
    # ── Local action handler (fallback si n8n indispo) ────────────────────────
    ...
    def get_system_prompt_injection(self, context_id: str | None = None) -> str:
        return (
            ...
            "Utilise device_status pour vérifier l'état avant d'agir si l'utilisateur pose une question sur l'état des appareils."
        )
