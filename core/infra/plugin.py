...
class ProxmoxPlugin(BasePlugin):
        ...
        return [
            ...
            },
            {
                ...
                "function": {
                    ...
                    "x_confirm_message": "Confirmer l'action sur la VM ?",
                },
            },
            {
                "type": "function",
                "function": {
                    ...
                    "x_confirm_required": True,
                    "x_confirm_message": "Confirmer le lancement du backup ?",
                },
            },
            {
                "type": "function",
                "function": {
                    ...
                    "x_confirm_required": True,
                    "x_confirm_message": "Confirmer la création du snapshot ?",
                },
            },
            {
                "type": "function",
    ...
    def get_semantic_utterances(self) -> dict[str, list[str]]:
        return {
            "function_gemma": [
                ...
                "mémoire serveur", "charge serveur",
            ]
        }
    ...
    def get_system_prompt_injection(self, context_id: str | None = None) -> str:
        return (
            ...
            "Fonctions disponibles : vm_list, vm_power, vm_backup, vm_snapshot, node_stats, storage_status.\n"
            "Pour vm_power, vm_backup et vm_snapshot demande TOUJOURS une confirmation avant d'exécuter."
        )
